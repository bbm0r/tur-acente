...
async function main() {
  ...
  // ── legal pages ───────────────────────────────────────────────
  const pages = [
    { slug: "hakkimizda", titleTr: "Hakkımızda", bodyTr: "Tur Acente, yurt dışı paket turlarında uzmanlaşmış bir seyahat acentesidir. Mısır, Rusya, İtalya, Benelüks ve Yunanistan başta olmak üzere keyifli ve güvenli tatiller sunuyoruz." },
    { slug: "kosullar", titleTr: "Kullanım Koşulları", bodyTr: "Bu sayfada hizmet kullanım koşulları yer alır." },
    { slug: "gizlilik", titleTr: "Gizlilik ve KVKK Aydınlatma Metni", bodyTr: "Kişisel verileriniz KVKK kapsamında işlenir ve korunur. Pasaport bilgileri yalnızca operasyon amacıyla şifreli saklanır." },
    { slug: "iptal-iade", titleTr: "İptal ve İade Koşulları", bodyTr: "İptal koşulları kalkışa kalan süreye göre uygulanır: 30 günden önce %10, 15-30 gün arası %50, 15 günden az %100." },
  ];
